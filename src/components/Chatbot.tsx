      ...
      {open && (
        <div
          style={{
            ...
            bottom: 100,
            right: 24,
            left: 24,                    // Mobile par left bhi set for centering/full width
            width: "auto",               // Auto width with left/right
            maxWidth: "380px",           // Desktop max width
            height: "80vh",              // Flexible height
            maxHeight: "90vh",            // Max 90% screen
            minHeight: "450px",          // Minimum for desktop
        ...
        >
          ...
          <div
            style={{
              flex: 1,
              padding: "16px 16px 80px 16px",  // Extra bottom padding for input space
              overflowY: "auto",
            }}
          >
            {messages.length === 0 && (
